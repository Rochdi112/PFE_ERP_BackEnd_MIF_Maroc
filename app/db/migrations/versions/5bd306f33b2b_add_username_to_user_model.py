...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("admin", "responsable", "technicien", "client", name="userrole"),
            nullable=False,
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("corrective", "preventive", name="interventiontype"),
            nullable=False,
        ),
        sa.Column(
            "statut",
    ...
    op.create_index(
        op.f("ix_historiques_interventions_id"),
        "historiques_interventions",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_historiques_interventions_id"), table_name="historiques_interventions"
    )
