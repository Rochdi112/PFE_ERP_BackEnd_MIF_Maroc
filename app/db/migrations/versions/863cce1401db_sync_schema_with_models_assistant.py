...
def upgrade() -> None:
    ...
    # Create DB ENUM types first to ensure columns that reference them can be
    # created/altered safely.
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'typeclient') THEN
            CREATE TYPE typeclient AS ENUM ('entreprise', 'collectivite',
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'niveaucompetence') THEN
            CREATE TYPE niveaucompetence AS ENUM ('debutant', 'intermediaire',
                                                  'avance', 'expert');
        END IF;
    END$$;
    """
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'typecontrat') THEN
            CREATE TYPE typecontrat AS ENUM ('maintenance_preventive',
                                             'maintenance_corrective',
                                             'maintenance_complete',
                                             'support_technique', 'contrat_cadre');
        END IF;
    END$$;
    """
    )
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'statutcontrat') THEN
            CREATE TYPE statutcontrat AS ENUM ('brouillon', 'en_cours', 'expire',
                                               'resilie', 'suspendu');
        END IF;
    END$$;
    """
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'modefacturation') THEN
            CREATE TYPE modefacturation AS ENUM ('mensuel', 'trimestriel',
                                                 'annuel');
        END IF;
    END$$;
    """
    ...
    BEGIN
        IF NOT EXISTS (
                SELECT 1 FROM pg_type WHERE typname = 'prioriteintervention'
            ) THEN
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'frequenceplanning') THEN
            CREATE TYPE frequenceplanning AS ENUM ('journalier', 'hebdomadaire',
                                                   'mensuel', 'trimestriel',
                                                   'semestriel', 'annuel');
        END IF;
    END$$;
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'statutplanning') THEN
            CREATE TYPE statutplanning AS ENUM ('actif', 'suspendu', 'termine',
                                                'en_retard');
        END IF;
    END$$;
    """
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'reporttype') THEN
            CREATE TYPE reporttype AS ENUM ('interventions', 'equipements',
                                            'techniciens', 'clients', 'dashboard',
                                            'planning', 'stock', 'financial');
        END IF;
    END$$;
    """
    )
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'reportstatus') THEN
            CREATE TYPE reportstatus AS ENUM ('pending', 'generating', 'completed',
                                              'failed', 'expired');
        END IF;
    END$$;
    """
    ...
    BEGIN
        IF NOT EXISTS (
                SELECT 1 FROM pg_type WHERE typname = 'disponibilitetechnicien'
            ) THEN
            CREATE TYPE disponibilitetechnicien AS ENUM (
                'disponible',
                'occupe',
                'conge',
                'formation',
    ...
    op.create_index(
        "idx_piece_reference", "pieces_detachees", ["reference"], unique=False
    )
    op.create_index(
        "idx_piece_stock",
        "pieces_detachees",
    ...
    op.create_index(
        op.f("ix_pieces_detachees_date_creation"),
        "pieces_detachees",
        ["date_creation"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pieces_detachees_id"), "pieces_detachees", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_pieces_detachees_is_active"),
        "pieces_detachees",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pieces_detachees_nom"), "pieces_detachees", ["nom"], unique=False
    )
    op.create_index(
        op.f("ix_pieces_detachees_reference"),
        "pieces_detachees",
        ["reference"],
        unique=True,
    )
    op.create_index(
        op.f("ix_pieces_detachees_stock_actuel"),
        "pieces_detachees",
        ["stock_actuel"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_facture_contrat_echeance",
        "factures",
        ["contrat_id", "date_echeance"],
        unique=False,
    )
    op.create_index("idx_facture_statut", "factures", ["statut_paiement"], unique=False)
    op.create_index(
        op.f("ix_factures_contrat_id"), "factures", ["contrat_id"], unique=False
    )
    op.create_index(
        op.f("ix_factures_date_creation"), "factures", ["date_creation"], unique=False
    )
    op.create_index(
        op.f("ix_factures_date_echeance"), "factures", ["date_echeance"], unique=False
    )
    op.create_index(
        op.f("ix_factures_date_emission"), "factures", ["date_emission"], unique=False
    )
    op.create_index(op.f("ix_factures_id"), "factures", ["id"], unique=False)
    op.create_index(
        op.f("ix_factures_numero_facture"), "factures", ["numero_facture"], unique=True
    )
    op.create_index(
        op.f("ix_factures_statut_paiement"),
        "factures",
        ["statut_paiement"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["piece_detachee_id"], ["pieces_detachees.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("intervention_id", "piece_detachee_id"),
    )
    op.create_index(
        "idx_intervention_piece",
        "interventions_pieces",
        ["intervention_id", "piece_detachee_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interventions_pieces_date_utilisation"),
        "interventions_pieces",
        ["date_utilisation"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interventions_pieces_intervention_id"),
        "interventions_pieces",
        ["intervention_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interventions_pieces_piece_detachee_id"),
        "interventions_pieces",
        ["piece_detachee_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_mouvement_piece_date",
        "mouvements_stock",
        ["piece_detachee_id", "date_mouvement"],
        unique=False,
    )
    op.create_index(
        "idx_mouvement_type", "mouvements_stock", ["type_mouvement"], unique=False
    )
    op.create_index(
        op.f("ix_mouvements_stock_date_mouvement"),
        "mouvements_stock",
        ["date_mouvement"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mouvements_stock_id"), "mouvements_stock", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_mouvements_stock_intervention_id"),
        "mouvements_stock",
        ["intervention_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mouvements_stock_piece_detachee_id"),
        "mouvements_stock",
        ["piece_detachee_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mouvements_stock_type_mouvement"),
        "mouvements_stock",
        ["type_mouvement"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mouvements_stock_user_id"),
        "mouvements_stock",
        ["user_id"],
        unique=False,
    )
    op.add_column(
        "clients", sa.Column("nom_commercial", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "clients",
        sa.Column(
    ...
    op.add_column(
        "clients", sa.Column("secteur_activite", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("taille_entreprise", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("numero_siret", sa.String(length=14), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("numero_tva", sa.String(length=20), nullable=True)
    )
    op.add_column("clients", sa.Column("code_ape", sa.String(length=10), nullable=True))
    op.add_column(
        "clients", sa.Column("nom_contact", sa.String(length=255), nullable=False)
    )
    op.add_column(
        "clients", sa.Column("prenom_contact", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("fonction_contact", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("telephone", sa.String(length=20), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("telephone_mobile", sa.String(length=20), nullable=True)
    )
    op.add_column("clients", sa.Column("fax", sa.String(length=20), nullable=True))
    op.add_column(
        "clients", sa.Column("adresse_ligne1", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("adresse_ligne2", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("code_postal", sa.String(length=10), nullable=True)
    )
    ...
    op.add_column(
        "clients",
        sa.Column(
            "chiffre_affaires_annuel", sa.Numeric(precision=12, scale=2), nullable=True
        ),
    )
    op.add_column("clients", sa.Column("nb_employes", sa.Integer(), nullable=True))
    op.add_column(
        "clients", sa.Column("date_premier_contrat", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "clients", sa.Column("date_derniere_intervention", sa.DateTime(), nullable=True)
    )
    op.add_column("clients", sa.Column("notes_commerciales", sa.Text(), nullable=True))
    op.add_column(
        "clients", sa.Column("instructions_particulieres", sa.Text(), nullable=True)
    )
    op.alter_column(
        "clients",
        "date_modification",
    ...
    op.create_index(
        "idx_client_actif_creation",
        "clients",
        ["is_active", "date_creation"],
        unique=False,
    )
    op.create_index(
        "idx_client_nom_email", "clients", ["nom_entreprise", "email"], unique=False
    )
    op.create_index(
        "idx_client_secteur_ville",
        "clients",
        ["secteur_activite", "ville"],
        unique=False,
    )
    op.create_index(
        "idx_client_type_niveau",
        "clients",
        ["type_client", "niveau_service"],
        unique=False,
    )
    op.create_index(
        op.f("ix_clients_code_postal"), "clients", ["code_postal"], unique=False
    )
    op.create_index(
        op.f("ix_clients_date_creation"), "clients", ["date_creation"], unique=False
    )
    op.create_index(
        op.f("ix_clients_is_active"), "clients", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_clients_niveau_service"), "clients", ["niveau_service"], unique=False
    )
    op.create_index(
        op.f("ix_clients_nom_entreprise"), "clients", ["nom_entreprise"], unique=False
    )
    op.create_index(
        op.f("ix_clients_numero_siret"), "clients", ["numero_siret"], unique=True
    )
    op.create_index(
        op.f("ix_clients_secteur_activite"),
        "clients",
        ["secteur_activite"],
        unique=False,
    )
    op.create_index(
        op.f("ix_clients_type_client"), "clients", ["type_client"], unique=False
    )
    ...
    # Add domaine column to competences table if it doesn't exist
    op.execute(
        """
    DO $$
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns
                      WHERE table_name = 'competences' AND column_name = 'domaine') THEN
            ALTER TABLE competences ADD COLUMN domaine VARCHAR(100);
        END IF;
    END$$;
    """
    )
    # Add niveau_requis_minimum column to competences table if it doesn't exist
    op.execute(
        """
    DO $$
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns
                      ...
                      AND column_name = 'niveau_requis_minimum') THEN
            ALTER TABLE competences ADD COLUMN niveau_requis_minimum VARCHAR(50)
                                         DEFAULT 'intermediaire';
        END IF;
    END$$;
    """
    )
    # Add is_active column to competences table if it doesn't exist
    op.execute(
        """
    DO $$
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns
            ...
            ALTER TABLE competences ADD COLUMN is_active BOOLEAN DEFAULT TRUE;
        END IF;
    END$$;
    """
    )
    # Ensure existing rows don't violate the NOT NULL constraint before applying it.
    # Assumption: a sensible default domain 'general' is acceptable for legacy
    # rows with NULL.
    op.execute(
        """
    UPDATE competences
    ...
    op.alter_column(
        "competences", "domaine", existing_type=sa.VARCHAR(length=100), nullable=False
    )
    ...
    op.execute(
        "ALTER TABLE competences ALTER COLUMN niveau_requis_minimum DROP DEFAULT;"
    )
    op.execute(
        "ALTER TABLE competences ALTER COLUMN niveau_requis_minimum TYPE "
        "niveaucompetence USING niveau_requis_minimum::niveaucompetence;"
    )
    op.execute(
        "ALTER TABLE competences ALTER COLUMN niveau_requis_minimum SET DEFAULT "
        "'intermediaire'::niveaucompetence;"
    )
    op.drop_constraint(op.f("competences_nom_key"), "competences", type_="unique")
    op.create_index(
        "idx_competence_actif_domaine",
        "competences",
        ["is_active", "domaine"],
        unique=False,
    )
    op.create_index(
        "idx_competence_nom_domaine", "competences", ["nom", "domaine"], unique=False
    )
    op.create_index(
        op.f("ix_competences_domaine"), "competences", ["domaine"], unique=False
    )
    ...
    op.add_column(
        "contrats", sa.Column("date_renouvellement", sa.Date(), nullable=True)
    )
    op.add_column(
        "contrats",
        sa.Column("montant_annuel", sa.Numeric(precision=12, scale=2), nullable=True),
    )
    op.add_column(
        "contrats",
    ...
    op.add_column(
        "contrats", sa.Column("temps_reponse_urgence", sa.Integer(), nullable=True)
    )
    op.add_column(
        "contrats", sa.Column("temps_reponse_normal", sa.Integer(), nullable=True)
    )
    op.add_column(
        "contrats",
        sa.Column(
            "taux_disponibilite", sa.Numeric(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "contrats",
        sa.Column("penalites_retard", sa.Numeric(precision=10, scale=2), nullable=True),
    )
    op.add_column(
        "contrats", sa.Column("nb_interventions_incluses", sa.Integer(), nullable=True)
    )
    op.add_column(
        "contrats", sa.Column("nb_interventions_utilisees", sa.Integer(), nullable=True)
    )
    op.add_column(
        "contrats",
        sa.Column("heures_maintenance_incluses", sa.Integer(), nullable=True),
    )
    op.add_column(
        "contrats",
        sa.Column("heures_maintenance_utilisees", sa.Integer(), nullable=True),
    )
    op.add_column(
        "contrats", sa.Column("equipements_couverts", sa.Text(), nullable=True)
    )
    op.add_column(
        "contrats", sa.Column("contact_client", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "contrats",
        sa.Column("contact_responsable", sa.String(length=255), nullable=True),
    )
    ...
    op.create_index(
        op.f("ix_contrats_client_id"), "contrats", ["client_id"], unique=False
    )
    op.create_index(
        op.f("ix_contrats_date_creation"), "contrats", ["date_creation"], unique=False
    )
    op.create_index(
        op.f("ix_contrats_date_debut"), "contrats", ["date_debut"], unique=False
    )
    op.create_index(
        op.f("ix_contrats_date_fin"), "contrats", ["date_fin"], unique=False
    )
    op.create_index(
        op.f("ix_contrats_is_active"), "contrats", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_contrats_mode_facturation"),
        "contrats",
        ["mode_facturation"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contrats_numero_contrat"), "contrats", ["numero_contrat"], unique=True
    )
    op.create_index(op.f("ix_contrats_statut"), "contrats", ["statut"], unique=False)
    op.create_index(
        op.f("ix_contrats_type_contrat"), "contrats", ["type_contrat"], unique=False
    )
    op.alter_column(
        "documents", "date_upload", existing_type=postgresql.TIMESTAMP(), nullable=False
    )
    op.create_index(
        "idx_document_intervention_upload",
        "documents",
        ["intervention_id", "date_upload"],
        unique=False,
    )
    op.create_index(
        op.f("ix_documents_date_upload"), "documents", ["date_upload"], unique=False
    )
    op.create_index(
        op.f("ix_documents_intervention_id"),
        "documents",
        ["intervention_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_documents_nom_fichier"), "documents", ["nom_fichier"], unique=False
    )
    # Add missing type_equipement column first
    op.add_column(
        "equipements",
        sa.Column("type_equipement", sa.VARCHAR(length=100), nullable=True),
    )
    # Then alter it to be NOT NULL
    op.alter_column(
        "equipements",
        "type_equipement",
    ...
    op.create_index(
        "idx_equipement_client_statut",
        "equipements",
        ["client_id", "statut"],
        unique=False,
    )
    op.create_index(
        "idx_equipement_created_type",
        "equipements",
        ["created_at", "type_equipement"],
        unique=False,
    )
    op.create_index(
        "idx_equipement_statut_criticite",
        "equipements",
        ["statut", "criticite"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_equipements_client_id"), "equipements", ["client_id"], unique=False
    )
    op.create_index(
        op.f("ix_equipements_code_interne"),
        "equipements",
        ["code_interne"],
        unique=True,
    )
    op.create_index(
        op.f("ix_equipements_contrat_id"), "equipements", ["contrat_id"], unique=False
    )
    op.create_index(
        op.f("ix_equipements_created_at"), "equipements", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_equipements_criticite"), "equipements", ["criticite"], unique=False
    )
    op.create_index(
        op.f("ix_equipements_localisation"),
        "equipements",
        ["localisation"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_equipements_numero_serie"),
        "equipements",
        ["numero_serie"],
        unique=True,
    )
    op.create_index(
        op.f("ix_equipements_statut"), "equipements", ["statut"], unique=False
    )
    op.create_index(
        op.f("ix_equipements_type_equipement"),
        "equipements",
        ["type_equipement"],
        unique=False,
    )
    op.create_foreign_key(
        None, "equipements", "contrats", ["contrat_id"], ["id"], ondelete="SET NULL"
    )
    op.create_foreign_key(
        None, "equipements", "clients", ["client_id"], ["id"], ondelete="SET NULL"
    )
    ...
    op.create_index(
        "idx_historique_intervention",
        "historiques_interventions",
        ["intervention_id", "user_id", "horodatage"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historiques_interventions_horodatage"),
        "historiques_interventions",
        ["horodatage"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historiques_interventions_intervention_id"),
        "historiques_interventions",
        ["intervention_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historiques_interventions_statut"),
        "historiques_interventions",
        ["statut"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historiques_interventions_user_id"),
        "historiques_interventions",
        ["user_id"],
        unique=False,
    )
    op.alter_column(
        ...
        existing_type=postgresql.ENUM(
            ...
            "basse",
            "programmee",
            name="prioriteintervention",
        ),
        nullable=False,
    )
    op.alter_column(
        "interventions", "equipement_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.create_index(
        "idx_intervention_client_statut",
        "interventions",
        ["client_id", "statut"],
        unique=False,
    )
    op.create_index(
        "idx_intervention_dates",
        "interventions",
        ["date_creation", "date_limite"],
        unique=False,
    )
    op.create_index(
        "idx_intervention_equipement_type",
        "interventions",
        ["equipement_id", "type"],
        unique=False,
    )
    op.create_index(
        "idx_intervention_statut_priorite",
        "interventions",
        ["statut", "priorite"],
        unique=False,
    )
    op.create_index(
        "idx_intervention_technicien_statut",
        "interventions",
        ["technicien_id", "statut"],
        unique=False,
    )
    op.create_index(
        "idx_intervention_type_urgence",
        "interventions",
        ["type", "urgence"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interventions_client_id"), "interventions", ["client_id"], unique=False
    )
    op.create_index(
        op.f("ix_interventions_contrat_id"),
        "interventions",
        ["contrat_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interventions_date_limite"),
        "interventions",
        ["date_limite"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interventions_equipement_id"),
        "interventions",
        ["equipement_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interventions_priorite"), "interventions", ["priorite"], unique=False
    )
    op.create_index(
        op.f("ix_interventions_technicien_id"),
        "interventions",
        ["technicien_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interventions_urgence"), "interventions", ["urgence"], unique=False
    )
    op.create_foreign_key(
        None, "interventions", "users", ["created_by_id"], ["id"], ondelete="SET NULL"
    )
    op.alter_column(
        "notifications",
        "date_envoi",
    ...
    op.create_index(
        "idx_notification_date", "notifications", ["date_envoi"], unique=False
    )
    op.create_index(
        "idx_notification_user_intervention",
        "notifications",
        ["user_id", "intervention_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notifications_canal"), "notifications", ["canal"], unique=False
    )
    op.create_index(
        op.f("ix_notifications_date_envoi"),
        "notifications",
        ["date_envoi"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notifications_intervention_id"),
        "notifications",
        ["intervention_id"],
        unique=False,
    )
    ...
    op.execute(
        "ALTER TABLE plannings ALTER COLUMN frequence TYPE frequenceplanning "
        "USING frequence::frequenceplanning;"
    )
    op.execute(
        "ALTER TABLE plannings ALTER COLUMN frequence SET DEFAULT "
        "'mensuel'::frequenceplanning;"
    )
    op.alter_column(
        "plannings",
        "statut",
        existing_type=postgresql.ENUM(
            "actif", "suspendu", "termine", "en_retard", name="statutplanning"
        ),
        nullable=False,
    ...
    op.create_index(
        "idx_planning_equipement_frequence",
        "plannings",
        ["equipement_id", "frequence"],
        unique=False,
    )
    op.create_index(
        "idx_planning_statut_prochaine",
        "plannings",
        ["statut", "prochaine_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_plannings_date_creation"), "plannings", ["date_creation"], unique=False
    )
    op.create_index(
        op.f("ix_plannings_equipement_id"), "plannings", ["equipement_id"], unique=False
    )
    op.create_index(
        op.f("ix_plannings_frequence"), "plannings", ["frequence"], unique=False
    )
    op.create_index(
        op.f("ix_plannings_is_active"), "plannings", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_plannings_prochaine_date"),
        "plannings",
        ["prochaine_date"],
        unique=False,
    )
    ...
    op.add_column(
        "report_schedules", sa.Column("filters_json", sa.JSON(), nullable=True)
    )
    op.add_column(
        "report_schedules", sa.Column("parameters_json", sa.JSON(), nullable=True)
    )
    op.add_column(
        "report_schedules", sa.Column("error_count", sa.Integer(), nullable=False)
    )
    op.add_column(
        "report_schedules", sa.Column("created_at", sa.DateTime(), nullable=False)
    )
    op.add_column(
        "report_schedules", sa.Column("updated_at", sa.DateTime(), nullable=False)
    )
    op.add_column(
        "report_schedules", sa.Column("template_id", sa.Integer(), nullable=True)
    )
    op.alter_column(
        "report_schedules",
        "timezone",
    ...
    op.alter_column(
        "report_schedules", "email_enabled", existing_type=sa.BOOLEAN(), nullable=False
    )
    op.alter_column(
        "report_schedules",
        "email_recipients",
    ...
    op.alter_column(
        "report_schedules", "run_count", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "report_schedules", "success_count", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "report_schedules", "created_by_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.create_index(
        op.f("ix_report_schedules_is_active"),
        "report_schedules",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_report_schedules_last_run_at"),
        "report_schedules",
        ["last_run_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_report_schedules_name"), "report_schedules", ["name"], unique=False
    )
    op.create_index(
        op.f("ix_report_schedules_report_type"),
        "report_schedules",
        ["report_type"],
        unique=False,
    )
    op.drop_constraint(
        op.f("report_schedules_created_by_id_fkey"),
        "report_schedules",
        type_="foreignkey",
    )
    op.create_foreign_key(None, "report_schedules", "users", ["created_by_id"], ["id"])
    op.create_foreign_key(
        None, "report_schedules", "report_templates", ["template_id"], ["id"]
    )
    ...
    op.add_column(
        "reports", sa.Column("generation_duration", sa.Integer(), nullable=True)
    )
    ...
    op.execute(
        "ALTER TABLE reports ALTER COLUMN report_type TYPE reporttype "
        "USING report_type::reporttype;"
    )
    op.execute(
        "ALTER TABLE reports ALTER COLUMN report_type SET DEFAULT "
        "'interventions'::reporttype;"
    )
    op.execute("ALTER TABLE reports ALTER COLUMN report_format DROP DEFAULT;")
    op.execute(
        "ALTER TABLE reports ALTER COLUMN report_format TYPE reportformat "
        "USING report_format::reportformat;"
    )
    op.execute(
        "ALTER TABLE reports ALTER COLUMN report_format SET DEFAULT "
        "'pdf'::reportformat;"
    )
    op.execute("ALTER TABLE reports ALTER COLUMN status DROP DEFAULT;")
    op.execute(
        "ALTER TABLE reports ALTER COLUMN status TYPE reportstatus "
    ...
    op.alter_column(
        "reports", "created_by_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.drop_constraint(op.f("reports_access_token_key"), "reports", type_="unique")
    op.create_index(
        op.f("ix_reports_access_token"), "reports", ["access_token"], unique=True
    )
    op.create_index(
        op.f("ix_reports_created_by_id"), "reports", ["created_by_id"], unique=False
    )
    op.drop_constraint(
        op.f("reports_created_by_id_fkey"), "reports", type_="foreignkey"
    )
    ...
    op.add_column(
        "technicien_competence",
        sa.Column("date_acquisition", sa.DateTime(), nullable=False),
    )
    op.add_column(
        "technicien_competence",
    ...
    op.add_column(
        "technicien_competence",
        sa.Column("validee_par", sa.String(length=255), nullable=True),
    )
    op.alter_column(
        "technicien_competence",
        "technicien_id",
    ...
    op.create_index(
        "idx_technicien_competence_niveau",
        "technicien_competence",
        ["technicien_id", "niveau"],
        unique=False,
    )
    op.execute("ALTER TABLE techniciens ALTER COLUMN niveau_technicien DROP DEFAULT;")
    op.execute(
        "ALTER TABLE techniciens ALTER COLUMN niveau_technicien TYPE niveaucompetence "
        "USING niveau_technicien::niveaucompetence;"
    )
    op.execute(
        "ALTER TABLE techniciens ALTER COLUMN niveau_technicien SET DEFAULT "
        "'intermediaire'::niveaucompetence;"
    )
    op.execute("ALTER TABLE techniciens ALTER COLUMN disponibilite DROP DEFAULT;")
    op.execute(
        "ALTER TABLE techniciens ALTER COLUMN disponibilite TYPE "
        "disponibilitetechnicien USING disponibilite::disponibilitetechnicien;"
    )
    op.execute(
        "ALTER TABLE techniciens ALTER COLUMN disponibilite SET DEFAULT "
        "'disponible'::disponibilitetechnicien;"
    )
    op.create_index(
        "idx_technicien_actif_equipe",
        "techniciens",
        ["is_active", "equipe"],
        unique=False,
    )
    op.create_index(
        "idx_technicien_equipe_dispo",
        "techniciens",
        ["equipe", "disponibilite"],
        unique=False,
    )
    op.create_index(
        "idx_technicien_zone_niveau",
        "techniciens",
        ["zone_intervention", "niveau_technicien"],
        unique=False,
    )
    op.create_index(
        op.f("ix_techniciens_disponibilite"),
        "techniciens",
        ["disponibilite"],
        unique=False,
    )
    op.create_index(
        op.f("ix_techniciens_equipe"), "techniciens", ["equipe"], unique=False
    )
    op.create_index(
        op.f("ix_techniciens_is_active"), "techniciens", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_techniciens_niveau_technicien"),
        "techniciens",
        ["niveau_technicien"],
        unique=False,
    )
    op.create_index(
        op.f("ix_techniciens_numero_badge"),
        "techniciens",
        ["numero_badge"],
        unique=True,
    )
    op.create_index(
        op.f("ix_techniciens_user_id"), "techniciens", ["user_id"], unique=True
    )
    op.create_index(
        op.f("ix_techniciens_zone_intervention"),
        "techniciens",
        ["zone_intervention"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_user_created_role", "users", ["created_at", "role"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_user_username_role", "users", ["username", "role"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        ...
        "niveau_technicien",
        existing_type=postgresql.ENUM(
            "debutant", "intermediaire", "avance", "expert", name="niveaucompetence"
        ),
    ...
    op.drop_index(
        "idx_technicien_competence_niveau", table_name="technicien_competence"
    )
    op.alter_column(
        "technicien_competence",
        "competence_id",
    ...
    op.add_column(
        "reports",
        sa.Column("generation_log", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.drop_constraint(None, "reports", type_="foreignkey")
    op.drop_constraint(None, "reports", type_="foreignkey")
    op.create_foreign_key(
        op.f("reports_created_by_id_fkey"),
        "reports",
        "users",
        ["created_by_id"],
        ["id"],
    ...
    op.create_unique_constraint(
        op.f("reports_access_token_key"),
        "reports",
        ["access_token"],
        postgresql_nulls_not_distinct=False,
    )
    op.alter_column(
        "reports", "created_by_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "reports",
        "access_token",
    ...
    op.alter_column(
        ...
        "report_format",
        existing_type=postgresql.ENUM(
            "pdf", "excel", "csv", "json", name="reportformat"
        ),
    ...
    op.add_column(
        "report_schedules",
        sa.Column(
            "keep_reports_days", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "report_schedules",
    ...
    op.add_column(
        "report_schedules",
        sa.Column(
            "max_reports_to_keep", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "report_schedules",
    ...
    op.add_column(
        "report_schedules",
        sa.Column(
            "date_creation", postgresql.TIMESTAMP(), autoincrement=False, nullable=False
        ),
    )
    ...
    op.drop_index(
        op.f("ix_report_schedules_report_type"), table_name="report_schedules"
    )
    op.drop_index(op.f("ix_report_schedules_name"), table_name="report_schedules")
    op.drop_index(
        op.f("ix_report_schedules_last_run_at"), table_name="report_schedules"
    )
    op.drop_index(op.f("ix_report_schedules_is_active"), table_name="report_schedules")
    op.alter_column(
        "report_schedules", "created_by_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "report_schedules", "success_count", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "report_schedules", "run_count", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "report_schedules",
        "email_recipients",
    ...
    op.alter_column(
        "report_schedules", "email_enabled", existing_type=sa.BOOLEAN(), nullable=True
    )
    op.alter_column(
        "report_schedules",
        "timezone",
    ...
    op.alter_column(
        "interventions", "equipement_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "interventions",
        "priorite",
    ...
    op.drop_index(
        op.f("ix_historiques_interventions_user_id"),
        table_name="historiques_interventions",
    )
    op.drop_index(
        op.f("ix_historiques_interventions_statut"),
        table_name="historiques_interventions",
    ...
    op.add_column(
        "equipements",
        sa.Column(
            "frequence_entretien", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
    )
    ...
    op.alter_column(
        "documents", "date_upload", existing_type=postgresql.TIMESTAMP(), nullable=True
    )
    ...
    op.create_unique_constraint(
        op.f("contrats_numero_contrat_key"),
        "contrats",
        ["numero_contrat"],
        postgresql_nulls_not_distinct=False,
    )
    ...
    op.alter_column(
        "competences", "domaine", existing_type=sa.VARCHAR(length=100), nullable=True
    )
    ...
    op.create_unique_constraint(
        op.f("clients_user_id_key"),
        "clients",
        ["user_id"],
        postgresql_nulls_not_distinct=False,
    )
    op.create_unique_constraint(
        op.f("clients_email_key"),
        "clients",
        ["email"],
        postgresql_nulls_not_distinct=False,
    )
    ...
    op.drop_index(
        op.f("ix_mouvements_stock_type_mouvement"), table_name="mouvements_stock"
    )
    op.drop_index(
        op.f("ix_mouvements_stock_piece_detachee_id"), table_name="mouvements_stock"
    )
    op.drop_index(
        op.f("ix_mouvements_stock_intervention_id"), table_name="mouvements_stock"
    )
    op.drop_index(op.f("ix_mouvements_stock_id"), table_name="mouvements_stock")
    op.drop_index(
        op.f("ix_mouvements_stock_date_mouvement"), table_name="mouvements_stock"
    )
    ...
    op.drop_index(
        op.f("ix_interventions_pieces_piece_detachee_id"),
        table_name="interventions_pieces",
    )
    op.drop_index(
        op.f("ix_interventions_pieces_intervention_id"),
        table_name="interventions_pieces",
    ...
    op.drop_index(
        op.f("ix_pieces_detachees_stock_actuel"), table_name="pieces_detachees"
    )
    ...
    op.drop_index(
        op.f("ix_pieces_detachees_date_creation"), table_name="pieces_detachees"
    )
