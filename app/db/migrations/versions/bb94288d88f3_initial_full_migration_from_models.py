    ...
    if dialect == "sqlite":
        ...
        with op.batch_alter_table("historiques_interventions", schema=None) as batch_op:
            batch_op.alter_column(
                "intervention_id", existing_type=sa.INTEGER(), nullable=False
            )
        ...
        op.drop_constraint(
            op.f("documents_intervention_id_fkey"), "documents", type_="foreignkey"
        )
        ...
        op.drop_constraint(
            op.f("historiques_interventions_intervention_id_fkey"),
            "historiques_interventions",
            type_="foreignkey",
        )
        op.drop_constraint(
            op.f("historiques_interventions_user_id_fkey"),
            "historiques_interventions",
            type_="foreignkey",
        )
        op.create_foreign_key(
        ...
        op.drop_constraint(
            op.f("interventions_equipement_id_fkey"),
            "interventions",
            type_="foreignkey",
        )
        op.drop_constraint(
            op.f("interventions_technicien_id_fkey"),
            "interventions",
            type_="foreignkey",
        )
        op.create_foreign_key(
        ...
        op.drop_constraint(
            op.f("notifications_intervention_id_fkey"),
            "notifications",
            type_="foreignkey",
        )
        op.drop_constraint(
        ...
        op.drop_constraint(
            op.f("plannings_equipement_id_fkey"), "plannings", type_="foreignkey"
        )
        op.create_foreign_key(
            None,
            "plannings",
        ...
        op.drop_constraint(
            op.f("technicien_competence_competence_id_fkey"),
            "technicien_competence",
            type_="foreignkey",
        )
        op.drop_constraint(
            op.f("technicien_competence_technicien_id_fkey"),
            "technicien_competence",
            type_="foreignkey",
        )
        op.create_foreign_key(
        ...
        op.alter_column(
            "techniciens", "user_id", existing_type=sa.INTEGER(), nullable=False
        )
        op.drop_constraint(
            op.f("techniciens_user_id_fkey"), "techniciens", type_="foreignkey"
        )
        op.create_foreign_key(
            None, "techniciens", "users", ["user_id"], ["id"], ondelete="CASCADE"
        )
...
def downgrade() -> None:
    ...
    if dialect == "sqlite":
        ...
        with op.batch_alter_table("historiques_interventions", schema=None) as batch_op:
            ...
            batch_op.alter_column(
                "intervention_id", existing_type=sa.INTEGER(), nullable=True
            )
        with op.batch_alter_table("techniciens", schema=None) as batch_op:
            batch_op.alter_column("user_id", existing_type=sa.INTEGER(), nullable=True)
    else:
        ...
        op.alter_column(
            "techniciens", "user_id", existing_type=sa.INTEGER(), nullable=True
        )
        ...
        op.create_foreign_key(
            op.f("plannings_equipement_id_fkey"),
            "plannings",
            "equipements",
            ["equipement_id"],
            ["id"],
        ...
        op.create_foreign_key(
            op.f("documents_intervention_id_fkey"),
            "documents",
            "interventions",
            ["intervention_id"],
            ["id"],
